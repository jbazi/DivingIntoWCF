...
namespace Client.HelloWorldServiceReference {
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="Name", Namespace="http://schemas.datacontract.org/2004/07/FirstWCF_App")]
    ...
    public interface IHelloWorld {
        ...
        string SayHello(Client.HelloWorldServiceReference.Name person);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IHelloWorld/SayHello", ReplyAction="http://tempuri.org/IHelloWorld/SayHelloResponse")]
        System.Threading.Tasks.Task<string> SayHelloAsync(Client.HelloWorldServiceReference.Name person);
    }
    ...
    public partial class HelloWorldClient : System.ServiceModel.ClientBase<Client.HelloWorldServiceReference.IHelloWorld>, Client.HelloWorldServiceReference.IHelloWorld {
        ...
        public string SayHello(Client.HelloWorldServiceReference.Name person) {
            return base.Channel.SayHello(person);
        }
        
        public System.Threading.Tasks.Task<string> SayHelloAsync(Client.HelloWorldServiceReference.Name person) {
